...
Route::post('/employee/complaints/update', [EmployeController::class, 'update'])
...
Route::middleware(['auth:sanctum'])->group(function () {
    Route::post('/employee/complaints/{id}/reserve', [EmployeController::class, 'reserveComplaint']);
     Route::post('/complaint/cancel', [EmployeController::class, 'cancelReservation']);
});
